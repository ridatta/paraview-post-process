...
dataSet = 'u' # specify dataset
dname = 'Test' # specify what data
ftype = '.vtk' # file type
isVector = 0  # specify if vector data

# Input and Output directory
inDir = '/Users/Rishabh/Dropbox (MIT)/PUFFIN/Codes/Paraview/Macros/paraview-post-process/'  # Input dir
outDir = '/Users/Rishabh/Dropbox (MIT)/PUFFIN/Data/Other/' + dname + '/' # Output dir
...
for jj in tid:
	...
	np.savetxt(outDir + fname + '.csv' ,out,fmt='%1.5e', delimiter=',')
	# Delete current data
	Delete(data)
	del data
print('Done')
